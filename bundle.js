(function () {
    ...
    decode_codepoint.replaceCodePoint;
    decode_codepoint.fromCodePoint;

    var require$$0 = decodeDataHtml;

    var require$$1 = decodeDataXml;

    var require$$2 = decode_codepoint;
    ...
    var decode_codepoint_js_1 = __importDefault(require$$2);
